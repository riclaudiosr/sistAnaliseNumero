...
<div class="container">
    <div class="wrapper">
        ...
        <div class="row">
            <div class="top-list">
                <span class="title-content">Tabela de Jogos</span>
                ...
                <div class="top-list-right ">
                    <?php
                    echo "<a href='" . URLADM . "result-jogos/index' class='btn btn-primary'>Conferir</a>";
                    ?>
                </div>
                <div class="top-list-right ">
                    <?php
                            ...
                            <td class="list-body-content">
                                <div class="dropdown-action">
                                    ...
                                    <div id="actionDropdown<?php echo $id; ?>" class="dropdown-action-item">
                                        ...
                                        echo "<a href='" . URLADM . "result-jogo/index?key=$id'>Conferir</a>";
