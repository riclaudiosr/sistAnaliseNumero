...
class AdmsListDatas 
{
    ...
    private int $limitResult = 50; // $page Recebe a quantidade de registros que deve retornar do banco de dados 
    ...
    public function listDatas(int $page = null): void
    {
        ...
        $listUsers->fullRead("SELECT id,colUm,colDois,colTres,colQuatro,colCinco,colSeis,colSete,colOite,colNove,colDez,colOnze,colDoze,colTrez,colQuatz,colQuinz,acertos,creatdat
                    FROM sequencia
                    ORDER BY id DESC
    ...
    public function searchData(): void
    {
       ...
       $this->resultPg = $pagination->getResult();
        ...
        $listUsers = new \App\adms\Models\helper\AdmsRead();
        $listUsers->fullRead(
                   "SELECT id,colUm,colDois,colTres,colQuatro,colCinco,colSeis,colSete,colOite,colNove,colDez,colOnze,colDoze,colTrez,colQuatz,colQuinz,acertos,creatdat
                    FROM sequencia
                    WHERE creatdat BETWEEN  :date_in AND :date_fn
                    ORDER BY id DESC
